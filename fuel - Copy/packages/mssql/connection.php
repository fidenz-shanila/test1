...
//			@sqlsrv_close($this->connectionId);
	...
	*/
	...
	{ //echo $server . '/' . $user . '/' . $password . '/'. $database; exit;
		...
		if (function_exists("sqlsrv_connect"))
		{
			...
			{
				$connectionCredentials = array("UID" => $user, "PWD" => $password, "Database" => $database, 'ReturnDatesAsStrings'=> true);
				$this->connectionId = sqlsrv_connect($server, $connectionCredentials) or die($this->displayErrorPath());
			}
	...
	*
	*/
 	private function displayErrorPath()
	{
