	...
	<thead>
		<tr>
			...
			<th width="10%" id="col2"></th>
                        <th width="2%"></th>
			<th width="45%" id="col3"></th>
			<th width="20%" id="col4"></th>
			<th width="20%" id="col5"></th>
		</tr>
	</thead>
</table>
<div id="dialog-form" style="display:none;">
	...
	<div id="searchforjob" class="" style="height:100%; width:100%; background-color:#B9F4D3;" >
    	
        <div class="content">
        	
            <h1>SEARCH FOR JOB(S)</h1>
            	...
            	<div class="c1">
                    <table class="table-1 advance_search" width="100%" id="job_advanced_search">
                        ...
                        <tr>
                            ...
                            <td valign="top" align="center">
								<input id="criteriaTxt" class="field1 filter_field" type="text" data-label="Search Criteria" name="criteria" />
							</td>
                        </tr>
                    </table>
                </div>
                <div class="c1">
                    <table class="table-1 advance_search" width="100%" id="job_advanced_search">
                        ...
                        <tr>
                            ...
                            <td valign="top" align="center">
								<input id="ASCriteriaJ_2" class="filter_field field2" type="" data-label="Search Criteria" name="advance[criteria]" />
							</td>
                        </tr>
                    </table>
                </div>
                            ...
                            <td valign="top" align="center">
								<select id="dateEquality" class="filter_field field3 select-1" data-label="Search Field" name="date[field]" id="">
									...
									<option value="Planned Start Date">Planned Start Date</option>
                                                                        <option value="Testing start date">Testing start date</option>
                                                                        <option value="Testing end date">Testing end date</option>
								</select>
							</td>
                            <td valign="top" align="center">
