<form action="" id="contacts_listing_filter" class="grid_filter">
    ...
    <table  class="" border="0" width="100%" >
        <tr>
            <td><table  style="margin:5px; border:1px solid #a1a1a1;margin-right:5px" ><tr><td>
                ...
                <h1 style="font-size:200%;">REPORTS LISTING</h1>
    ...
    <table  class="" border="0" width="100%"  >
        <tr><th align="center" id="vNumber" style="color:#0209c7;cursor:default" width="15%" ><u>NUMBER...click</u></th><td align="center" id="vArtrfact" style="cursor:default" width="42%"><u><b>ARTEFACT DESCRIPTION...click</b></u></td><td align="center" id="vCansO" style="cursor:default" width="22%"><u><b>CLIENT / OWNER...click</b></u></td><td align="center" id="vStatus" style="cursor:default" width="21%"><u><b>STATUS...click</b></u></td></tr>
        </table>
