...
<div id="InsertQuote" title="frmInsertQuotes"  style="display:none;overflow:hidden;background-color:#FEE69C;" >
    <iframe id="InsertQuoteIframe" width="100%" height="100%"  style="background-color:#FEE69C;overflow:hidden;border:none"></iframe>
</div>


<div id="InsertQuoteNextWendow" title="frmSelectInternalAndContact" height="500px"   style="display:none;background-color:#8FA5FA;overflow:hidden;" >
    <iframe id="InsertQuoteNextIF" width="100%" height="850px"  style="background-color:#8FA5FA;border:none;overflow:hidden;"></iframe>
</div>
