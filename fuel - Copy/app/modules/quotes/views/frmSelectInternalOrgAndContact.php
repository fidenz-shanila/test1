...
<form>
   <div id="selectinternalorg" style="background-color:#C7DDFE">
    	<div width="100%" style="text-align:center"><h1>SELECT NMI OWNER FORM</h1></div>
        <div class="content">
	...
	<tr>
		<td width="70%">
			<table width="99%"   border="0" style="background-color:#7BAFFD;text-align: center;" class="tbl_internal midTable">
				...
				<tr>
					<td align="center">
						<div style="width:90%; height:20px; background-color:#CCC;" class="middiv" id="div_project_msg"></div>
					</td>
				</tr>
				<tr>
					<td height="300px">
						...
						$i=0; echo '<ol id="selectable_projects" style="height:400px" >'; foreach(\Quotes\Model_Quote::get_nmi_internal_projects()as $key => $value){ echo '<li value='.$key.'  class="ui-widget-content Contactcon">'.$value.'</li>' ;$i++; };echo '</ol>'; ?>
						</td></tr></table>
						</div>
					</td>
				</tr>
		...
		<td width="30%">
			<table width="99%" align="center" border="0" class="tbl_internal midTable" style="background-color:#D3A8FF">
				...
				<tr>
					<td align="center">
						<div style="width:90%; height:20px; background-color:#CCC;" class="middiv" id="div_contact_msg"></div>
					</td>
				</tr>
				<tr>
					<td  height="700px">
						...
						<?php //echo $form->build_field('txt_projects'); echo $project_list;
						$i=0; echo '<ol id="selectable_contacts" >'; foreach(\Quotes\Model_Quote::get_nmi_internal_contacts()as $key => $value){ echo '<li value='.$key.'  class="ui-widget-content Contactcon">'.$value.'</li>' ;$i++; };echo '</ol>'; ?>
						</td></tr></table>
						</div>
					</td>
				</tr>
             ...
             <div class="box-2">
                ...
                <div class="blk" ><input type="button" class="button2" id="sel_select_button" value="SELECT" /></div>
                    ...
                    <div class="blk"><input type="button" class="button2" onclick='closeIframeforQuote_Con();' id="btn_close" value="cancel / close" /></div>
                </div>
            </div>
