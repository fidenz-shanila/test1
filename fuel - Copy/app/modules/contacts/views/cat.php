...
<form action="" method="post" >
	...
	<h2  style="text-align:center; margin-left:20%;margin-right:20%;">SELECT CATEGORY(S) TO APPLY TO CONTACT LIST</h2>
            
	   <table  class=""   border="0" style="height:300px;width:80%;margin-left:10%;margin-top:20px; background-color: #8fa8f7;">
	        <tr>
	            <td class="" style="height:25%;width:80%;background-color: #ffdbc7;text-align: center;"></br>
                        <h3 ><u>CONTACT CATEGORY</u></h3>
                        <?php $a=array(''=>''); ?>
                    ...
                    <tr>
	            <td style="height:25%;width:80%;background-color: aliceblue; text-align: center;"></br>
                        <h3 ><u>ORGANISATION CATEGORY</u></h3>
...
<!--                           <button href="" onClick="setDataJs();" id="abc" style="height:40px;width:15%;margin-left:80%; margin-right:5px;;" class=""><b>APPLY</b></button>-->
                           <input type="button" style="height:40px;width:15%;margin-left:80%; margin-right:5px;font-weight:bold;" onClick="setDataJs();" value="APPLY"/>
                        </td>
