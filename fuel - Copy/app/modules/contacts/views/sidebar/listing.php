...
function openNewCOnFunction(oprnuser)
{
   
    
    //alert(oprnuser);
   var ser=$("#"+oprnuser).click();
   //alert(ser);
    //cleanSetIntervalFunction1(oprnuser)
...
function openWindowAndClose()
{
    ...
    intervalId=setInterval(function(){ 
        ...
        if(($('#insertCheckr2nd').val()).length != 0){
           var oprnuser=$('#insertCheckr2nd').val();
           openNewCOnFunction(oprnuser);
            //preventDefault();
