<form action="" id="contacts_listing_filter" class="grid_filter">
    ...
    <table  class="" border="0" width="100%" >
        <tr>
            <td><table  style="margin:5px; border:1px solid #a1a1a1;margin-right:5px" ><tr><td>
                ...
                <h1 style="font-size:200%;">RECEIPT AND DESPATCH LISTING</h1>
    ...
    <table  class="" border="0" width="100%"  >
        <tr><th align="center" id="vNumber" style="color:#0209c7;cursor:default" width="15%" ><u>QUOTE NO...click</u></th><td align="center" id="vArtrfact" style="cursor:default" width="28%"><u><b>DESCRIPTION...click</b></u></td><td align="center" id="vCansO" style="cursor:default" width="28%"><u><b>CLIENT / OWNER...click</b></u></td><td align="center" id="vStatus" style="cursor:default" width="28%"><u><b>STATUS...click</b></u></td></tr>
        </table>
...
<script type="text/javascript">
    $('.excel_button').on('click',function(){
        var countOfData = $("#disabledCount").val();
            var didConfirm = confirm("Are you sure you to want to send receipt and despatch data for "+countOfData+" jobs to MS Excel?");
                if (didConfirm == true) {
