    ...
    <table border="0" id="jobFilter" class="filter_table">
        ...
        <tr class="sr">
         ...
         <tr class="">
            ...
            <td bgcolor="#79bdb9" width="15%" style="border:1px solid #a1a1a1;"> 
...
<script type="text/javascript">
	dt = $('.datatable').dataTable( {
			...
			"sAjaxSource": "<?php echo \Uri::create('receipts/listing_data'); ?>",
			"fnServerParams": function ( aoData ) {
				...
				$.ajax({
				 	url: "<?php echo \Uri::create('receipts/dropdown_data'); ?>",
				 	type: "GET",
				 	dataType: 'json',
					data: filter,
       ...
       // $('#parent_search').colorbox({inline:true});
      ...
      $('#search_clear').click(function(){
			...
			$('#search_clear, #parent_search').toggle();
			dt.fnDraw();
		});
      ...
      $('#searchFieldshidden').css("display", "none");
       ...
       $('#parent_search').click(function(){
        ...
        $("#selectField").prop("selectedIndex",3);
