...
<div id="dialog-form" style="display:none;">
	...
	<div id="search_invoice" class="" style="height:100%; width:100%; background-color:#d1d9e8;">
    	
        <div class="content">
        	
            <h1>SEARCH INVOICE LISTING</h1>
                        ...
                        <tr>
                            <td valign="top" align="center">
								<select class="filter_field field1 select-1" data-label="Search Field" name="field" id="selectField">
									...
									<option value="Fee due (unlocked)">Fee due (unlocked)</option>
									<option value="Fee due (locked)">Fee due (locked)</option>
									<option value="Fee justification">Fee justification</option>
