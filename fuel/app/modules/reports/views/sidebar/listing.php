    ...
    <table border="0" id="jobFilter" class="filter_table">
        ...
        <tr class="sr">
         ...
         <tr class="">
            ...
            <td bgcolor="#d19f6d" width="15%" style="border:1px solid #a1a1a1;"> 
                <label for="">STATUS:</label>
               <select name="status" class="filter_field">
                   <option ></option>
                    <option value="All Live" selected>All Live</option>
                    <option value="Live: No report date">Live: No report date</option>
                    <option value="Live: Ready for sending">Live: Ready for sending</option>
                    <option value="Live: Has expiry">Live: Has expiry</option>
                    <option value="All Closed">All Closed</option>
                    <option value="Closed: No expiry">Closed: No expiry</option>
                    <option value="Closed: Not Issued">Closed: Not Issued</option>
...
<script type="text/javascript">
	dt = $('.datatable').dataTable( {
			...
			"sAjaxSource": "<?php echo \Uri::create('reports/listing_data'); ?>",
			"fnServerParams": function ( aoData ) {
				...
				$.ajax({
				 	url: "<?php echo \Uri::create('reports/dropdown_data'); ?>",
				 	type: "GET",
				 	dataType: 'json',
					data: filter,
		...
		$('#advance_search12').click(function(){
			...
			var do_run = 0;
			 ...
			 $('#criteriaTxt').val(''); 
                ...
                //invisible top lable 012/5/2013 sd
    ...
    $('table.advance_search #SelectFieldCriteria_2').each(function(){
			...
			$(this).change(function(){
                ...
                if(img_path=='')
                {
                 ...
                 // $.colorbox({href:'..img\dashboard\bg.jpeg'});
                }else{
                 var clorbox_open = $.colorbox({href:img_path});  
                }

         }
         function call_to_pdf(){ 
